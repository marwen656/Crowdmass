 ...
 * @author Amine
 */
public class ChallengeToValidateController implements Initializable, ControlledScreen {
	...
	public void initialize(URL url, ResourceBundle rb) {
		listt = ChallengeDelegate.retrieveChallengeToValidate();
		...
		table.setOnMouseClicked(new EventHandler<Event>() {
			...
			public void handle(Event e) {
				...
				idChallenge = Integer.parseInt(colid.getCellData(
						...
						.toString());
				ChallengeDelegate.seeChallenge(idChallenge);
